...
Rcpp_FULL_Together_Multigroup <- function(R, burn_in, N, N_groups, mean_log_delta, sd_log_delta, pi_new, mcmc_alpha, alpha_new, chol, TOT_Y_new, K, l, f, exon_id, One_transcript, one_transcript) {
    .Call('_BANDITS_Rcpp_FULL_Together_Multigroup', PACKAGE = 'BANDITS', R, burn_in, N, N_groups, mean_log_delta, sd_log_delta, pi_new, mcmc_alpha, alpha_new, chol, TOT_Y_new, K, l, f, exon_id, One_transcript, one_transcript)
}
