...
Alternative ways to compute gene-transcript matchings are illustrated in *tximport* [@tximport] vignette.

If the reads are aligned to the genome first, we compute a gene-transcript association from the gtf file via *GenomicFeatures* [@GenomicFeatures] library.
...
gene_tr_id_gtf = data.frame( gene_id = gene_id, transcript_id = tr_id )
...
gene_tr_id_fasta = data.frame( gene_id = as.character(gene_name),
